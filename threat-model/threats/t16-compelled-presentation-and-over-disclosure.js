  ...
  "response": [
    {
      ...
      "type": "Accept",
      "desc": "Because the optical barcode carries a static signature over a fixed field set, selective disclosure at presentation time is not available within this specification. [=E1|Issuers=] can mitigate over-disclosure up front by encoding only the attributes essential to the document's purpose, and ecosystems that require minimal disclosure at presentation should consider complementary credentials in other forms. The lack of selective disclosure capability of a static barcode is acknowledged and accepted for the use cases this specification targets."
    }
  ],
  "elements": [
    "E2",
