  ...
  "response": [
    {
      ...
      "type": "Reduce",
      "desc": "[=E1|Issuers=] can mitigate over-disclosure up front by encoding only the attributes essential to a document's purpose, and ecosystems that require minimal disclosure at presentation time can consider complementary credentials in other forms."
    },
    {
      "id": "R16.2",
      "name": "Do Not Use Optical Barcodes When Selective Disclosure is a Requirement",
      "type": "Accept",
      "desc": "Because the optical barcode carries a static signature over a fixed field set, selective disclosure at presentation time is not possible through this specification. The lack of a selective disclosure capability in a static barcode is acknowledged and accepted for the use cases this specification targets."
    }
  ],
  "elements": [
    "E2",
