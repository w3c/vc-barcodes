(function () {
  var threat = {
  "id": "T20",
  "name": "Key Resolution and Key-Management Spoofing",
  ...
  "response": [
    {
      ...
      "type": "Reduce",
      "desc": "[=E3|Verifiers=] pin trusted [=E1|issuer=] keys in the [=S3|trust store=] rather than trusting whatever a live resolution returns, and treat unexpected key changes as cause to decline pending out-of-band confirmation. [=E1|Issuers=] harden the infrastructure that publishes their keys and adopt clear key-management governance: defined authoritative key locations, documented provenance, and routine rotation."
    }
  ],
  "elements": [
    "F3",
