(function () {
  ...
  "response": [
    {
      "id": "R20.1",
      "name": "Pin Trust Anchors",
      "type": "Reduce",
      "desc": "[=E3|Verifiers=] pin trusted [=E1|issuer=] keys in the [=S3|trust store=] rather than trusting whatever a live resolution returns, and treat unexpected key changes as cause to decline pending out-of-band confirmation."
    },
    {
      "id": "R20.2",
      "name": "Govern Key Management",
      "type": "Reduce",
      "desc": "[=E1|Issuers=] harden the infrastructure they use to publish their keys and adopt clear key-management governance such as defined authoritative key locations, documented provenance, and routine rotation."
    }
  ],
  "elements": [
    "F3",
